...
int main(int argc, char* argv[]) {
	...
	// const char* en_filename = "NetAssist.exe";
	// const char* out_filename = "EN_NetAssist.exe";
	// const char* en_filename = "02.jpg";
	// const char* out_filename = "en_02.jpg";
	...
	input.open(en_filename, ios_base::in | ios_base::binary);
